	...
	//                                                    //
	// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
	function IB_Entity(_config = {}) : IB_Base(_config) constructor {
		...
		#region position
			...
			// public
			static position_get_x			  = function() {
				return __.entity.transform.position.x.current.value;
			};
			static position_get_y			  = function(_apply_z_position = true) {
			...
			static position_get_z			  = function() {
				return __.entity.transform.position.z.current.value;
			};
											    
			static position_set_x			  = function(_x, _lerp_movement = false, _lerp_speed = position_get_x_lerp_speed(true)) {
				position_set_x_lerp_target(_x, _lerp_speed);
				if (!_lerp_movement) position_snap_x();
				return self;
			};
			static position_set_y			  = function(_y, _lerp_movement = false, _lerp_speed = position_get_y_lerp_speed(true)) {
				position_set_y_lerp_target(_y, _lerp_speed);
				if (!_lerp_movement) position_snap_y();
				return self;
			};
			static position_set_z			  = function(_z, _lerp_movement = false, _lerp_speed = position_get_z_lerp_speed(true)) {
				position_set_z_lerp_target(_z, _lerp_speed);
				if (!_lerp_movement) position_snap_z();
				return self;
			};
											    
			static position_adjust_x		  = function(_amount, _lerp_movement = false, _lerp_speed = position_get_x_lerp_speed(true)) {
				position_set_x(position_get_x() + _amount, _lerp_movement, _lerp_speed);
				return self;
			};
			static position_adjust_y		  = function(_amount, _lerp_movement = false, _lerp_speed = position_get_y_lerp_speed(true)) {
				position_set_y(position_get_y(false) + _amount, _lerp_movement, _lerp_speed);
				return self;
			};
			static position_adjust_z		  = function(_amount, _lerp_movement = false, _lerp_speed = position_get_z_lerp_speed(true)) {
				position_set_z(position_get_z() + _amount, _lerp_movement, _lerp_speed);
				return self;
			};
			
			static position_snap_x			  = function(_x_target = position_get_x_lerp_target()) {
			...
			static position_snap_y			  = function(_y_target = position_get_y_lerp_target(false)) {
			...
			static position_snap_z			  = function(_z_target = position_get_z_lerp_target()) {
			...
			static position_get_bottom		  = function() {
				return position_get_top() + size_get_height();
			};
			static position_get_center_h	  = function() {
				return position_get_left() + (size_get_width() * 0.5);
			};
			static position_get_center_v	  = function() {
				return position_get_top() + (size_get_height() * 0.5);
			};
			static position_get_left		  = function() {
				return position_get_x();
			};
			static position_get_right		  = function() {
				return position_get_left() + size_get_width();
			};
			static position_get_top			  = function() {
				return position_get_y(true);
			};
				
			#region ext
			
				static position_get_x_start		  = function() {
					return __.entity.transform.position.x.start.value;
				};
				static position_get_x_lerp_target = function() {
					return __.entity.transform.position.x.target.value;
				};
				static position_get_x_lerp_speed  = function(_get_start_speed = false) {
					if (_get_start_speed) {
				...
				static position_get_y_start		  = function() {
					return __.entity.transform.position.y.start.value;
				};
				static position_get_y_lerp_target = function(_apply_z_position = true) {
					if (_apply_z_position) {
						return __.entity.transform.position.y.target.value - position_get_z();	
					}
					return __.entity.transform.position.y.target.value;
				};
				static position_get_y_lerp_speed  = function(_get_start_speed = false) {
					if (_get_start_speed) {
				...
				static position_get_z_start		  = function() {
					return __.entity.transform.position.z.start.value;
				};
				static position_get_z_lerp_target = function() {
					return __.entity.transform.position.z.target.value;
				};
				static position_get_z_lerp_speed  = function(_get_start_speed = false) {
					if (_get_start_speed) {
				...
				static position_set_x_start		  = function(_x_start) {
					__.entity.transform.position.x.start.value = _x_start;
					return self;
				};
				static position_set_x_lerp_target = function(_x_target, _x_speed = position_get_x_lerp_speed(true)) {
					__.entity.transform.position.x.target.value = _x_target;
					position_set_x_lerp_speed(_x_speed, false);
					return self;
				};
				static position_set_x_lerp_speed  = function(_x_speed, _update_start = true) {
				...
				static position_set_y_start		  = function(_y_start) {
					__.entity.transform.position.y.start.value = _y_start;
					return self;
				};
				static position_set_y_lerp_target = function(_y_target, _y_speed = position_get_y_lerp_speed(true)) {
					__.entity.transform.position.y.target.value = _y_target;
					position_set_y_lerp_speed(_y_speed, false);
					return self;
				};	
				static position_set_y_lerp_speed  = function(_y_speed, _update_start = true) {
				...
				static position_set_z_start		  = function(_z_start) {
					__.entity.transform.position.z.start.value = _z_start;
					return self;
				};
				static position_set_z_lerp_target = function(_z_target, _z_speed = position_get_z_lerp_speed(true)) {
					__.entity.transform.position.z.target.value = _z_target;
					position_set_z_lerp_speed(_z_speed, false);
					return self;
				};	
				static position_set_z_lerp_speed  = function(_z_speed, _update_start = true) {
			...
			with (__.entity.transform) {
				position = {
					x: {
						start:	 {
							value: ((_data[$ "x_start"] ?? _data[$ "x"]) ?? _self[$ "xstart"]) ?? 0,
						},
						current: {
							value: (_data[$ "x"] ?? _self[$ "x"]) ?? 0,
						},
						target:  {
					...
					y: {
						start:	 {
							value: ((_data[$ "y_start"] ?? _data[$ "y"]) ?? _self[$ "ystart"]) ?? 0,
						},
						current: {
							value: (_data[$ "y"] ?? _self[$ "y"]) ?? 0,
						},
						target:  {
		...
		#region size
			...
			// public 
			static size_get_height = function(_apply_scale = true) {
				if (_apply_scale) {
					return __.entity.transform.size.height * abs(scale_get_y());
				}
				return __.entity.transform.size.height;
			};
			static size_get_width  = function(_apply_scale = true) {
				if (_apply_scale) {
					return __.entity.transform.size.width * abs(scale_get_x());
				}
			...
			static size_set_height = function(_height) {
		...
		#region scale
			...
			// public
			static scale_get			   = function() {
				return __.entity.transform.size.scale.factor.current.value;
			};
			static scale_get_lerp_target   = function() {
				return __.entity.transform.size.scale.factor.target.value;
			};
			static scale_get_lerp_speed	   = function(_get_start_speed = false) {
				if (_get_start_speed) {
			...
			static scale_get_x			   = function(_apply_scale_base = true, _apply_facing = false) {
			...
			static scale_get_x_lerp_target = function(_apply_scale_base = true, _apply_facing = false) {
			...
			static scale_get_x_lerp_speed  = function(_get_start_speed = false) {
				if (_get_start_speed) {
			...
			static scale_get_y			   = function(_apply_scale_base = true) {
				var _scale_y = __.entity.transform.size.scale.factor_y.current.value;
				if (_apply_scale_base) _scale_y *= scale_get();	
				return _scale_y;
			};
			static scale_get_y_lerp_target = function(_apply_scale_base = true, _apply_facing = false) {
			...
			static scale_get_y_lerp_speed  = function(_get_start_speed = false) {
				if (_get_start_speed) {
			...
			static scale_set			   = function(_scale, _lerp = false, _lerp_speed = scale_get_lerp_speed(true)) {
				scale_set_lerp_target(_scale, _lerp_speed);
				if (!_lerp) scale_snap();
				return self;
			};
			static scale_set_lerp_target   = function(_scale_target, _target_speed = scale_get_lerp_speed(true)) {
				__.entity.transform.size.scale.factor.target.value = _scale_target;
				scale_set_lerp_speed(_target_speed, false);
				return self;
			};
			static scale_set_lerp_speed	   = function(_scale_speed, _update_start = true) {
			...
			static scale_set_x			   = function(_scale_x, _lerp = false, _lerp_speed = scale_get_lerp_speed(true)) {
				scale_set_x_lerp_target(_scale_x, _lerp_speed);
				if (!_lerp) scale_snap_x();
				return self;
			};
			static scale_set_x_lerp_target = function(_scale_x_target, _x_target_speed = scale_get_lerp_speed(true)) {
				__.entity.transform.size.scale.factor_x.target.value = _scale_x_target;
				scale_set_x_lerp_speed(_x_target_speed, false);
				return self;
			};
			static scale_set_x_lerp_speed  = function(_scale_x_speed, _update_start = true) {
			...
			static scale_set_y			   = function(_scale_y, _lerp = false, _lerp_speed = scale_get_lerp_speed(true)) {
				scale_set_y_lerp_target(_scale_y, _lerp_speed);
				if (!_lerp) scale_snap_y();
				return self;
			};
			static scale_set_y_lerp_target = function(_scale_y_target, _y_target_speed = scale_get_lerp_speed(true)) {
				__.entity.transform.size.scale.factor_y.target.value = _scale_y_target;
				scale_set_y_lerp_speed(_y_target_speed, false);
				return self;
			};
			static scale_set_y_lerp_speed  = function(_scale_y_speed, _update_start = true) {
			...
			static scale_flip_x			   = function(_lerp_flip = false, _lerp_speed = scale_get_x_lerp_speed(true)) {
			...
			static scale_flip_y			   = function(_lerp_flip = false, _lerp_speed = scale_get_y_lerp_speed(true)) {
				__.entity.transform.size.scale.factor_y.target.value	  *= -1;
				__.entity.transform.size.scale.factor_y.target.speed.value = _lerp_speed;
				if (!_lerp_flip) scale_snap_y();
				return self;
			};
			static scale_squish			   = function(_scale) {
				__.entity.transform.size.scale.factor.current.value *= _scale;
				return self;
			};
			static scale_squish_x		   = function(_scale_x) {
				__.entity.transform.size.scale.factor_x.current.value *= _scale_x;
				return self;
			};
			static scale_squish_y		   = function(_scale_y) {
				__.entity.transform.size.scale.factor_y.current.value *= _scale_y;
				return self;
			};
			static scale_snap			   = function(_scale = scale_get_lerp_target()) {
				__.entity.transform.size.scale.factor.current.value = _scale;
				__.entity.transform.size.scale.factor.target.value  = _scale;
				return self;
			};
			static scale_snap_x			   = function(_scale_x = scale_get_x_lerp_target()) {
				__.entity.transform.size.scale.factor_x.current.value = _scale_x;
				__.entity.transform.size.scale.factor_x.target.value  = _scale_x;
				return self;
			};
			static scale_snap_y			   = function(_scale_y = scale_get_y_lerp_target()) {
				__.entity.transform.size.scale.factor_y.current.value = _scale_y;
		...
		#region angle
			...
			// public
			static angle_get = function() {
				return __.entity.transform.angle;
			};
			static angle_set = function(_angle) {
		...
		#region interactions
			...
			// public
			static intersecting_point = function(_x, _y) {
		...
		#region visuals
			...
			// public	
			static alpha_get		   = function() {
				return __.entity.visual.alpha;	
			};
			static alpha_set		   = function(_alpha) {
				__.entity.visual.alpha = _alpha;
				return self;
			};
			static color_get		   = function() {
				return __.entity.visual.color;	
			};
			static color_set		   = function(_color) {
				__.entity.visual.color = _color;
				return self;
			};
			static depth_get		   = function() {
				return __.entity.transform.depth;
			};
			static depth_set		   = function(_depth) {
				__.entity.transform.depth = _depth;
				return self;
			};
			static facing_get		   = function() {
				return __.entity.visual.facing;	
			};
			static facing_set		   = function(_facing) {
				__.entity.visual.facing = _facing;
				return self;
			};
			static render_bbox		   = function(_color = color_get(), _outline = true) {
			...
			static render_get_default  = function() {
				return __.entity.visual.render_default;	
			};
			static render_get_function = function() {
				return __.entity.visual.render_function;
			};
			static render_set_function = function(_function) {
