	...
	function _IB_Utility_Collision() constructor {
		...
		static ellipse					  = function(_x, _y, _radius, _object, _precise = false, _notme = true, _ratio = 0.5) {
			var _x1 = _x - _radius * 0.5;
			var _y1 = _y - _radius * 0.5 * _ratio;
			var _x2 = _x + _radius * 0.5;
			var _y2 = _y + _radius * 0.5 * _ratio;
			return collision_ellipse(_x1, _y1, _x2, _y2, _object, _precise, _notme);
		};
		static ellipse_list				  = function(_x, _y, _radius, _object, _precise = false, _notme = true, _list, _ordered = false, _ratio = 0.5) {
			var _x1 = _x - _radius * 0.5;
			var _y1 = _y - _radius * 0.5 * _ratio;
			var _x2 = _x + _radius * 0.5;
			var _y2 = _y + _radius * 0.5 * _ratio;
			return collision_ellipse_list(_x1, _y1, _x2, _y2, _object, _precise, _notme, _list, _ordered);
		};
	};
