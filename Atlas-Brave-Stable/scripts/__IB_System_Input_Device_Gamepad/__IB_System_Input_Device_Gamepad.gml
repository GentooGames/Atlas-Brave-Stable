	...
	function __IB_System_Input_Device_Gamepad(_config = {}) : __IB_System_Input_Device(_config) constructor {
		...
		static deadzone_get	   = function() {
			return gamepad_get_axis_deadzone(__.device_index);
		};
		...
		with (__) {
			...
			type	 = "gamepad";	
			desc	 =  gamepad_get_description(device_index);
			deadzone = _config[$ "deadzone"] ?? iceberg.input.__.gamepad_deadzone_default;
